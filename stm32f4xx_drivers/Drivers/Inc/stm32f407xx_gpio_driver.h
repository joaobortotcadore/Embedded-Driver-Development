...
typedef struct
{
	...
	uint8_t GPIO_PinPuPdControl; /* possible values from @GPIO_PUPD_SETTINGS */
...
#define GPIO_MODE_ALTFN         2 //ALTFN - ALTernate FuNction
#define GPIO_MODE_ANALOG        3
#define GPIO_MODE_IT_FT         4 //IT - InTerruption FT - Falling-edge Trigger
#define GPIO_MODE_IT_RT         5 //IT - InTerruption FT - Rising-edge Trigger
#define GPIO_MODE_IT_RFT        6 //IT - InTerruption FT - Rising-Falling-edge Trigger

/* @GPIO_OUTPUT_TYPE
 * GPIO pin possible output types. OP - OutPut */
#define GPIO_OP_TYPE_PP         0 //PP - Push-Pull
#define GPIO_OP_TYPE_OD         1 //OD - OpenDrain
...
#define GPIO_NO_PUPD            0 //PUPD - PullUp/PullDown
#define GPIO_PIN_PU             1 //PU - PullUp
#define GPIO_PIN_PD             2 //PD - PullDown
